...
<?php if (!empty($this->data['Project']['id'])): ?>
	...
	<?php echo $this->Html->link('<i class="icon-picture"></i>', array('controller' => 'media_items', 'action' => 'add', 'project' => $this->request->data['Project']['id']), array('class' => 'pull-left btn ajax', 'escape' => false, 'title' => 'Attach Media')); ?>
<?php endif ?>
