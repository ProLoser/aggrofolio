<h1><?php echo __('Resume Recommendation');?></h1>
<ul class="actions">
		<li><?php echo $this->Html->link(__('Edit Resume Recommendation'), array('action' => 'edit', $resumeRecommendation['ResumeRecommendation']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Resume Recommendation'), array('action' => 'delete', $resumeRecommendation['ResumeRecommendation']['id']), null, sprintf(__('Are you sure you want to delete # %s?'), $resumeRecommendation['ResumeRecommendation']['id'])); ?> </li>
...
<div class="resumeRecommendations view">
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Recommendor Uuid'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
