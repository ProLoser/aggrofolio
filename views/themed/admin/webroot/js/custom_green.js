...
$(function(){ 
	...
	$('#flashMessage, .alert_warning, .alert_info, .alert_success, .alert_error').click(function(){
		$(this).fadeOut();
	});
	...
	$('.header h1, .header h2, .header h3').click(function(){
		...
		$(el).parent().siblings().wrapAll('<div>');
	});
