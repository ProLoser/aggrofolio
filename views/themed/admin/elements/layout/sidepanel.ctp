...
<div id="left_menu">
	<ul id="main_menu">
		...
		<li>
			<?php echo $this->Html->link($this->Html->image('icons/comments.png', array('alt'=>'Posts')) . ' Blog', '#', array('escape' => false)); ?>
			<ul>
		...
		<li>
			...
			<ul>
				...
				<li><?php echo $this->Html->link('Categories', array('controller' => 'media_categories', 'action' => 'index'))?></li>
			</ul>	
		</li>
		<li>
