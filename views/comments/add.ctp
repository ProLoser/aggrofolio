<header>
	<h2>Add Comment</h2>
	<p class="sorting"><?php echo $this->Html->link('Return To Post', array('controller' => Inflector::pluralize($this->data['Comment']['foreign_model']), 'action' => 'view', $this->data['Comment']['foreign_key'])); ?></p>
</header>
<article>
	<section id="comments">
